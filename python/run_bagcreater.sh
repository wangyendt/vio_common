...
# root="/media/psf/work/data/time-space-calibration/mercury/20231018--camera_mocap_temporal"
...
python3 create_rosbag_for_images_in_dir.py "$root/cam0" "$root/cam.bag"
# python3 kalibr_bagcreater.py --imu $root/mav0/imu0/data.csv --output_bag $root/imu.bag
...
# 将SlamDemo采集的图片经过过采样得到批量bag
# root=/media/psf/work/data/slam/mercury/calibration-20231025
# python3 create_rosbag_for_images_in_dir.py "$root/image" "$root/cam" 20 10
