...
python3 imu_data_add_current_timestamp.py $root/gyro_acc.csv
python3 kalibr_bagcreater.py --folder $root --imu $root/gyro_acc_col_added.csv --output_bag $root/imu2.bag
